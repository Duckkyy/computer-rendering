...
def main(config_file, input_dir, output_dir, image_ext='mp4'):
    ...
    if os.path.isdir(input_dir):
        im_list = glob.iglob(input_dir + '/*.' + image_ext)
    else:
        im_list = [input_dir]
...
if __name__ == '__main__':
    ...
    output_dir = 'VideoPose3D/output_video'
    image_ext = 'mp4'
    input_dir = 'input_video'
    # main(args)
    main(config, input_dir, output_dir, image_ext)
